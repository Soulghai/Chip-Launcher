...
#define BONUS_ACCELERATION_POWER_DEFAULT 1.1f
#define BONUS_ACCELERATION_POWER_ADD_COEFF 0.5f
...
#define GRAVITATION_DEFAULT 0.30f
...
#define screenPlayerPositionY 240
